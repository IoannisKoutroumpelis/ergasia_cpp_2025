...
public:
    // Κατασκευαστής: Αρχικοποιεί το κατάστημα με τα paths των αρχείων και φορτώνει τα δεδομένα
    Eshop(const string& categoriesFile, const string& productsFile, const string& usersFile);

    // Καταστροφέας: Απελευθερώνει τη μνήμη που χρησιμοποιείται για τους δυναμικούς χρήστες
    ~Eshop();
